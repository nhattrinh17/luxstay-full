...
import './loginRegistrantionHeader.css';
...
function LoginRegistrantionHeader() {
    ...
    useEffect(() => {
        const clickSideOutPointer = function (e) {
            if (
        ...
        window.addEventListener('click', clickSideOutPointer);

        return function cleanup() {
            window.removeEventListener('click', clickSideOutPointer, true);
        };
        ...
        <div className="header">
            <div className="grid wide">
                <div className="row header-wap">
                    <Link to="/vi" class="ovelay__header--logo">
