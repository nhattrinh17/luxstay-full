...
function Header() {
    ...
    useEffect(() => {
        // const clickSideOutHeaderSearchDay = function (e) {
        //     if (
        ...
        // const clickSideOutHeaderSearchMount = (e) => {
        //     if (
        ...
        // const clickSideOutHeaderPointer = (e) => {
        //     if (
        ...
        //     };
        // });
        // window.addEventListener('click', clickSideOutHeaderSearchDay);
        // window.addEventListener('click', clickSideOutHeaderSearchMount);
        // window.addEventListener('click', clickSideOutHeaderPointer);

        return function cleanup() {
            // window.removeEventListener('click', clickSideOutHeaderSearchDay, true);
            // window.removeEventListener('click', clickSideOutHeaderSearchMount, true);
            // window.removeEventListener('click', clickSideOutHeaderPointer, true);
            ...
            <div className={cx('grid wide')}>
                <div className={cx('header-wap', 'row')}>
                    <div className={cx('header-logo')}>
                        <Link to="/" aria-current="page" className={cx('header-logo__link')}>
                    ...
                    <label htmlFor="mobile-bar" className="header-mobile__bar">
                    ...
                    <div className="header-navbar">
                        <div className="mobile-nav__top">
                            ...
                            <label htmlFor="mobile-bar" className="mobile-bar__close">
                        ...
                        <ul className="header-navbar__list">
                            <li className="header-navbar__item">
                                <Link
                                    to="/vi/login"
                                    className="header-navbar__item--link header-navbar__item--link-ative"
                                >
                                    Host
                                </Link>
                            </li>
                            <li className="header-navbar__item">
                                <Link to="/vi/registration" className="header-navbar__item--link">
                                    Đăng Kí
                                </Link>
                            </li>
                            <li className="header-navbar__item">
                                <Link to="/vi/login" className="header-navbar__item--link">
                                    Đăng Nhập
                                </Link>
                            </li>
                        </ul>
