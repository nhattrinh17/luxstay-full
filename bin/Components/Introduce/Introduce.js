                ...
                <div class="row ">
                    <div class="col l-6">
                        <div class="introduce-conten">
                            <Link to="/vi" class="introduce-conten__logo">
                            ...
                            <h2 class="introduce-conten__heading">TÌM KIẾM CHỖ Ở GIÁ TỐT NHẤT</h2>
                            <p class="introduce-conten__text">
                        ...
                        <div class="introduce-link">
                            <div class="row">
                                <div class="col l-5 c-0">
                                    <img src="https://luxstay.com/qr-code.png" alt="" class="introduce-link__qr" />
                                </div>
                                <div class="col l-7 c-12">
                                    <div class="row">
                                        <div class="col l-6 m-4 c-6">
                                            <Link to="" class="introduce-link__appstore">
                                                <img
                                                    src="https://luxstay.com/icons/apple-store.svg"
                                                    alt=""
                                                    class="introduce-link__img"
                                                />
                                            </Link>
                                        </div>
                                        <div class="col l-6 m-4 c-6">
                                            <Link to="" class="introduce-link__googleplay">
                                                <img
                    ...
                    <div class="col l-6">
                        <img src="https://luxstay.com/home/home-02.png" alt="" class="introduce-img" />
                    </div>
                </div>
            </div>
        </div>
