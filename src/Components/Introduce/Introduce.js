...
function Introduce() {
    return (
        <div className="grid wide">
            <div className={cx('container-introduce')}>
                <div className="row ">
                    <div className="col l-6">
                        <div className={cx('introduce-conten')}>
                            <Link to="/vi" className={cx('introduce-conten__logo')}>
                            ...
                            <h2 className={cx('introduce-conten__heading')}>TÌM KIẾM CHỖ Ở GIÁ TỐT NHẤT</h2>
                            <p className={cx('introduce-conten__text')}>
                                Luxstay hiện là nền tảng đặt phòng trực tuyến #1 Việt Nam. Đồng hành cùng chúng tôi, bạn
                                có những chuyến đi mang đầy trải nghiệm. Với Luxstay, việc đặt chỗ ở, biệt thự nghỉ
                                dưỡng, khách sạn, nhà riêng, chung cư... trở nên nhanh chóng, thuận tiện và dễ dàng.
                            </p>
                        </div>
                        <div className={cx('introduce-link')}>
                            <div className="row">
                                <div className="col l-5 c-0">
                                    <img
                                        src="https://luxstay.com/qr-code.png"
                                        alt=""
                                        className={cx('introduce-link__qr')}
                                    />
                                </div>
                                <div className="col l-7 c-12">
                                    <div className="row">
                                        <div className="col l-6 m-4 c-6">
                                            <Link to="" className={cx('introduce-link__appstore')}>
                                                <img
                                                    src="https://luxstay.com/icons/apple-store.svg"
                                                    alt=""
                                                    className={cx('introduce-link__img')}
                                                />
                                            </Link>
                                        </div>
                                        <div className="col l-6 m-4 c-6">
                                            <Link to="" className={cx('introduce-link__googleplay')}>
                                                <img
                                                    src="https://luxstay.com/icons/google-play.svg"
                                                    alt=""
                                                    className={cx('introduce-link__img')}
                                                />
                                            </Link>
                    ...
                    <div className="col l-6">
                        <img src="https://luxstay.com/home/home-02.png" alt="" className={cx('introduce-img')} />
                    </div>
                </div>
            </div>
        </div>
