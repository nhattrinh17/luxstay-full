...
function Header() {
    ...
    const clickSideOutElement = function (e) {
        if (
            document.querySelector('.header-search__day').contains(e.target) &&
        ...
        if (
            document.querySelector('.header-search__amount').contains(e.target) &&
        ...
        if (
            document.querySelector('.header--navbar__pointer').contains(e.target) &&
    ...
    return (
        <div className="header">
            <div className="grid wide">
                <div className="row header-wap">
                    <div className="header-logo">
                        <Link to="/" aria-current="page" className="header-logo__link">
                            <svg version="1.1" viewBox="0 0 50 50" style={{ width: 50, height: 50 }}>
                                <path
                                    pid="0"
                    ...
                    <div className="header-search">
                        ...
                        <div className="header-search__input--wap">
                            <input type="text" className="header-search__input" placeholder="Tìm Kiếm" required />
                            {/* Search histoy */}
                            <div className="header-search--history">
                                <span className="header-search--history__heading">Tìm kiếm gần đây</span>
                                <div className="header-search--history__boby">
                                    <i className="header-search--history__boby--location ti-location-pin"></i>
                                    <div className="header-search--history__boby--info">
                                        <span className="header-search--history__boby--info-name">Hồ Chí Minh</span>
                        ...
                        <div
                            className="header-search__day--box"
                            ref={chooseDay}
                            onBlur={() => (chooseDay.current.style.display = 'none')}
                        >
                            <input
                                type="date"
                                className="header-search__day--input"
                                value={day ? day : '17/11/2002'}
                                onChange={(e) => setDay(e.target.value)}
                            />
                        </div>
                        <div
                            className="header-search__amount"
                            onClick={() => {
                        ...
                        >
                            ...
                            <h2 className="header-search__amount--text">
                                {totalGuests ? totalGuests + ' khách' : 'Số khách'}
                            </h2>
                        </div>
                        <div className="header-search__amount-people" ref={amountPeople}>
                            <ul className="amount-people__list">
                                <li className="amount-people__item">
                                    ...
                                    <div className="amount-people__item--wap">
                                        <i
                                            className="amount-people__item--icon-minus fas fa-minus"
                                            onClick={() => {
                                                if (amountAdult >= 1) {
                                        ...
                                        <input
                                            type="number"
                                            className="amount-people__item--amount"
                                            value={amountAdult}
                                            readOnly
                                            min="0"
                                        />
                                        <i
                                            className="amount-people__item--icon-plus fas fa-plus"
                                            onClick={() => {
                                                setAmountAdult((pre) => pre + 1);
                                                setTotalGuests((pre) => pre + 1);
                                            }}
                                ...
                                <li className="amount-people__item">
                                    <div className="amount-people__item--lever">
                                        <p className="amount-people__item--lever--text">Trẻ em</p>
                                        <p className="amount-people__item--lever--des">2 - 12 tuổi</p>
                                    </div>
                                ...
                                <li className="amount-people__item">
                                    <div className="amount-people__item--lever">
                                        <p className="amount-people__item--lever--text">Trẻ sơ sinh</p>
                                        <p className="amount-people__item--lever--des">Dưới 2 tuổi</p>
                                    </div>
                            ...
                            <div className="amount-people__confirm">
                                <p
                                    href=""
                                    className="amount-people__confirm-delete"
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setAmountAdult(0);
                                        setAmountChildren(0);
                    ...
                    <label for="mobile-bar" className="header-mobile__bar">
                        <i className="fas fa-bars"></i>
                    </label>
                    <input type="checkbox" name="" id="mobile-bar" className="mobile-input__checkbox" />

                    <div className="header-navbar">
                        <div className="mobile-nav__top">
                            <div className="mobile-nav__logo">
                                <Link to="/" className="mobile-nav__logo--link">
                            ...
                            <label for="mobile-bar" className="mobile-bar__close">
                                <i className="fas fa-times"></i>
                            </label>
                        </div>
                        <ul className="header-navbar__list">
                            <li className="header-navbar__item">
                                <Link to="/login" className="header-navbar__item--link header-navbar__item--link-ative">
                                    Host
                                </Link>
                            </li>
                            <li className="header-navbar__item">
                                <Link to="/registration" className="header-navbar__item--link">
                                    Đăng Kí
                                </Link>
                            </li>
                            <li className="header-navbar__item">
                                <Link to="./login.html" className="header-navbar__item--link">
                                    Đăng Nhập
                                </Link>
                            </li>
                        </ul>
                        <div
                            className="header--navbar__pointer"
                            onClick={() => {
