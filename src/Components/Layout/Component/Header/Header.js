...
function Header() {
    ...
    const handleLogOut = async () => {
        if (user) {
            logOutUser(dispatch, navigate, user.accessToken, interceptCheckToken);
        }
    };

    useEffect(() => {
        // hideOnClickOutside(userTools.current, setIsOpenTool);
        // return () => {
                        ...
                        >
                            ...
                            <div className={cx('pointer')} ref={pointer}>
                                ...
                                <ul className={cx('pointer__lis--money')}>
                                    ...
                                    <li className={cx('pointer__item--money')}>
