        ...
        <div className="grid wide">
            <div class="container-place">
                ...
                <div class="row container-place__list">
                    <button className={placeHead === 0 ? 
                        "container-place__pre fas fa-chevron-left" : "container-place__pre fas fa-chevron-left active"}
                        onClick={() => 
                            {
                    ...
                    <button className={placeEnd === places.length ? 
                        "container-place__next fas fa-chevron-right" : "container-place__next fas fa-chevron-right active"}
                        onClick={() => 
                            {
                                setPlaceEnd(pre => pre += 1)
                                setplaceHead(pre => pre += 1)
                        ...
                        </button>
                    {
                        places.map((place, index) => {
                            return(
                                <Link to={"/vi" + place.path} className={(index >= placeHead && index <= placeEnd-1)?
                                         "col l-2-4 m-4 c-6 container-place__item active" : "col l-2-4 m-4 c-6 container-place__item"} key={index}>
